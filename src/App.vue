...
<v-app>
      ...
      <div class="flex" style="height:88vh">
            <div class="w-16 sm:w-48 bg-red-dark h-full flex-none">
                <div class="p-3 pt-4 sm:p-6 flex items-center justify-between">
                
                    <img src="foxbel-music.png" 
                    alt="" class="h-10 hidden sm:block">

                    <img src="foxbel-music-icon-1x.png" 
                    alt=""  @click="toggleNav" class="sm:hidden flex h-10 block sm:hidden ">
                   <!-- Responsive Menu Icon-->
                </div>
                <div class="hidden sm:block ml-6 text-white">
                  <div class="mb-8">
                    <h1 class="text-lg font-bold">Mi librería</h1>
                    <ul class="text-base pl-2 leading-5" style="list-style:none">
            ...
            <div :class="showMenu ? 'block absolute':'hidden'" class="w-36 z-10 bg-red-dark h-full flex-none">
                <div class="flex p-4 items-center justify-between">
                  <img src="foxbel-music-icon-2x.png" 
                  alt="" class="h-10">
                   <!-- Responsive Menu Icon-->
                  <div @click="toggleNav" class="sm:hidden">
                    <button type="button" class="outline-none text-white">
                ...
                <div  class="ml-6 text-white">
                  <div class="mb-8">
                    <h1 class="text-base font-bold">Mi librería</h1>
                    <ul class="text-sm pl-2 leading-5" style="list-style:none">
                      <li class="hover:text-red">Recientes</li>
                      <li class="hover:text-red">Artistas</li>
                      <li class="hover:text-red">Albums</li>
                      <li class="hover:text-red">Canciones</li>
                  ...
                  <div>
                    <h1 class="text-base font-bold">Playlist</h1>
                    <ul class="text-sm pl-2 leading-5" style="list-style:none">
                      <li class="hover:text-red">Metal</li>
                      <li class="hover:text-red" >Para bailar</li>
                      <li class="hover:text-red">Rock 90s</li>
            ...
            <div class="w-full h-full relative bg-white px-2 sm:px-20 overflow-y-scroll">
                <div class="w-full sticky top-0  py-3 sm:py-6 flex items-center justify-between  mb-0 sm:mb-5 bg-white" style="z-index:2">
                ...
                <div class="py-2">
                    <div class="w-full flex  sm:h-72 md:h-64 h-52">
                        <div class="w-auto hidden sm:block" style="position:relative">
                            <img :src="this.song_selected.album_cover" alt=""  class="w-full h-full">
                        ...
                        <div class="w-full text-white p-10" style="background-color:#A70000">
                            ...
                            <p class="hidden sm:block">Lorem ipsum, dolor sit amet co  nobis corrupti cumque repudiandae non minima doloremque odit unde laborum perferendis quidem.</p>
                ...
                <div class="py-3 ">
                    <div class="w-full flex flex-wrap">
                      <div v-for="(song,index) in array_songs" :key="index" class="p-2 w-40 sm:w-48">
      ...
      <div class="w-full flex itmes-center bg-red-light justify-between" style="height:12vh">
          <div class="sm:flex w-1/2 sm:w-1/3 h-full">
              <div class="flex items-center">
          ...
          <div class="sm:flex w-1/2 sm:w-2/3">
              <div class="flex flex-col justify-center items-center sm:mb-5 sm:w-1/2">
                  <div class="flex items-center text-white pt-5 sm:pt-0">
              ...
              <div class="flex items-center mr-10 text-white mt-2 sm:mt-0 sm:w-1/2 justify-end">
